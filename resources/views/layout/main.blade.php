                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="{{url('calon_mahasiswa')}}">Calon Mahasiswa</a></li>
                            <li><i class="fa fa-table"></i><a href="{{url('jurusan')}}">Jurusan</a></li>
                            <!-- <li><i class="fa fa-table"></i><a href="{{url('struk')}}">Struk</a></li> -->
                            <li><i class="fa fa-table"></i><a href="{{url('laporan')}}">Laporan</a></li>
                        </ul>
                    </li>
